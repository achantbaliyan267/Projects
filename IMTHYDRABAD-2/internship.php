...
<section id="Campus-Placements" class="py-5">
  <div class="container">
    <h2 class="section-title text-center mb-4" data-aos="fade-up" data-aos-delay="200">Campus Placements (Summer Internship)</h2>
    ...
    <div class="tab-content card bg-light p-4" id="Campus-PlacementsTabsContent" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="tab-pane fade show active"
        ...
        <h4 class="fw-semibold mb-3 text-center">Internship Program (IP)</h4>
        ...
        <h4 class="fw-semibold mb-3 text-center">Key dimensions of the Internship Program</h4>
        ...
        <h4 class="fw-semibold mb-3 text-center">Benefits of IP</h4>
        <p class="fs-6 lh-lg mb-4">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Concept of IP</h4>
        <p class="fs-6 lh-lg mb-4">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Internship Project Identification Process</h4>
        <p class="fs-6 lh-lg mb-3">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Internship Project Profiles</h4>
        <p class="fs-6 lh-lg mb-3">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Academic Prerequisites for Internships</h4>
        <p class="fs-6 lh-lg mb-4">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Internship Projects Selection / Allotment and Communication Process</h4>
        <p class="fs-6 lh-lg mb-3">
        ...
        <h4 class="fw-semibold mb-3 text-center" >Progress & Evaluation</h4>
        <p class="fs-6 lh-lg mb-3">
        ...
        <div class="row justify-content-center my-4" aria-label="Table 5">
          <div class="col-12 col-md-8">
            <div class="mb-3 text-center">
              <h4 class="mb-2 fw-semibold">Table 5: Summary of Assessment in Internship Program 2025</h4>
              <img src="https://www.imthyderabad.edu.in/assets/images/placements/internship-program-assessment.png" class="img-fluid" alt="Table 5: Summary of Assessment in Internship Program 2025">
            </div>
          </div>
        </div>
        ...
        <p class="fs-6 lh-lg mb-4">
         <strong> In cases where the intern may have to withdraw from the IP, the following procedure will be followed:</strong>
        </p>
        <div class="crs_list mb-4">
          <ul class="mb-0">
      ...
      <div class="tab-pane fade"
        ...
        <h4 class="fw-semibold mb-3 text-center">Students Committees For Placements</h4>
        ...
        <div class="text-center mt-2">
          <h4 class="text-dark">Email id: scop2025@imthyderabad.edu.in</h4>
        </div>
      </div>
      ...
      <div class="tab-pane fade"
         ...
         <h4 class="fw-semibold mb-4 text-center">Internship Reports</h4>
