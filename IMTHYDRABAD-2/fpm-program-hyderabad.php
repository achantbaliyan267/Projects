    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="bg-white p-4 rounded-4 mb-3">
                ...
                <h2 class="fw-bold text-dark border-bottom pb-2 text-center">PROGRAM OVERVIEW</h2>
            ...
            <div class="row mb-4">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <div class="card h-100 p-4">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="./images/fpm1.jpeg" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-warning text-dark rounded-pill px-3 py-1">View Profile</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-4">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="./images/fpm2.jpg" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-12 col-md-6 mb-3 mb-md-0">
                    <div class="card h-100 p-4">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="./images/fpm3.jpg" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-4">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="./images/fpm4.jpeg" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3 mb-md-0">
                    <div class="card h-100 p-4">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="./images/fpm5.jpg" class="img-fluid rounded-start" alt="Student Photo" style="height:16rem;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
