...
<body>
    <a href="https://kamleshyadav.com/cdn-cgi/content?id=.ncuUycuB3uPdpTWflNKe_skTXXL9TojhpVyWX2a6E0-1762765444.9055982-1.0.1.1-t6ZGjdDZZWEmO1639g2P95eCrI_FlCwTOTRix5B_gQE" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
    <div class="as_loader">
        <img src="images/loader.png" alt="" class="img-responsive">
    </div> 
    <div class="as_main_wrapper">
        <section class="as_header_wrapper">
            <div class="as_logo">
                <a href="javascript:;"><img src="images/logo.svg" alt=""></a>
            </div>
                    ...
                    <ul>
                        <li>
                            <a href="javascript:;">
                                ...
                                <span class="as_orange">Talk to our Astrogers -</span>+91-7982701690
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:;">
                                ...
                                <span class="as_orange">Talk to our Astrogers -</span><a class="pt-2" href="mailto:astrosusila2025@gmail.com "><span>astrosusila2025@gmail.com </span></a>
                                </div>
                            </a>
                        </li>
                    </ul>
                    <div class="as_right_info">
                        ...
                        <!-- <div class="as_cart">
                            <div class="as_cart_wrapper">
                                <span><img src="images/cart.svg" alt=""><span class="as_cartnumber">02</span></span>
                                $512
                            </div>
									...
									<ul>
										<li>
											<div class="as_cart_img">
												<img src="images/prod1_d.jpg" class="img-responsive">
											</div>
                ...
                <div class="as_menu_wrapper">
                    ...
                    <div class="as_menu">
                        <ul>
                            ...
                            <li><a href="#as_heading">about</a></li>
                ...
                <div class="row as_verticle_center">
                    <div class="col-lg-6 order-lg-1 col-md-6 order-md-1 col-sm-12 order-sm-1 col-12 order-2">
                        <div class="as_banner_slider">
                            <div class="as_banner_detail">
                                <h5 class="as_orange">Guru Vannakkam to all my esteemed Gurus,</h5>
                                <h1>I am Susila from Noida in the Delhi NCR. <br> Vedic, ALP, Jamakkol Aarudam and Prasannam</h1>
                                <p>CAs an astrology enthusiast and dedicated researcher, I love helping those seeking clarity and solace navigate the fascinating world of the stars. I am passionate about guiding others.</p>
                    ...
                    <div class="col-lg-6 order-lg-2 col-md-6 order-md-2 col-sm-12 order-sm-2 col-12 order-1">
                        <div class="as_banner_img text-center">
                            <img src="images/banner_image.png" alt="" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="as_service_box text-center">
                            <span class="as_icon">
                                <img src="images/service7.svg" alt="">                                 
                            </span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="as_service_box text-center">
                            <span class="as_icon">
                                <img src="images/service8.svg" alt="">                                 
                            </span>
                            ...
                            <ul> 
                                <li class="as_form_box">
                                    ...
                                    <div class="as_input_feild">
                                        ...
                                        <span><img src="images/date.svg" alt=""></span>
                                    </div>
                                </li>
                                <li class="as_form_box">
                                ...
                                <li class="as_form_box">
                                    ...
                                    <div class="as_input_feild"> 
                                        ...
                                        <span><img src="images/map1.svg" alt=""></span>
                                    </div> 
                                </li>
                                <li class="as_form_box">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="as_customer_box text-center">
                                    <span class="as_customer_img">
                                        ...
                                        <span><img src="images/quote1.svg" alt=""></span>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="512" data-speed="5000">512</span>+</span><img src="images/shape.svg" alt=""></span>
                                    <h4>Qualified Astrologers</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="62" data-speed="5000">62</span>+</span><img src="images/shape.svg" alt=""></span>
                                    <h4>Success Horoscope</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="94" data-speed="5000">94</span>+</span><img src="images/shape.svg" alt=""></span>
                                    <h4>Offices Worldwide</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="452" data-speed="5000">452+</span>+</span><img src="images/shape.svg" alt=""></span>
                                    <h4>Trust by million clients</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="12" data-speed="5000">12</span>+</span><img src="images/shape.svg" alt=""></span>
                                    <h4>Year experience</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_whychoose_box text-center">
                                    <span class="as_number"><span><span data-from="0" data-to="652" data-speed="5000">652+</span>+</span><img src="images/shape.svg" alt=""></span>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="text-left">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="as_blog_box">
                                        <div class="as_blog_img">
                                            <a href="blog_detail.html"><img src="images/blog1.jpg" alt="" class="img-responsive"></a>
                                            <span class="as_btn">July 29, 2020</span>
                                        </div>
                                        <ul>
                                            <li><a href="javascript:;"><img src="images/user.svg" alt="">By - Admin</a></li>
                                            <li><a href="javascript:;"><img src="images/comment.svg" alt="">0 comments</a></li>
                                        </ul>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="as_blog_box">
                                    <div class="as_blog_img">
                                        <a href="blog_detail.html"><img src="images/blog2.jpg" alt="" class="img-responsive"></a>
                                        <span class="as_btn">July 29, 2020</span>
                                    </div>
                                    <ul>
                                        <li><a href="javascript:;"><img src="images/user.svg" alt="">By - Admin</a></li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="as_blog_box">
                                    <div class="as_blog_img">
                                        <a href="blog_detail.html"><img src="images/blog3.jpg" alt="" class="img-responsive"></a>
                                        <span class="as_btn">July 29, 2020</span>
                                    </div>
                                    <ul>
                                        <li><a href="javascript:;"><img src="images/user.svg" alt="">By - Admin</a></li>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="row as_product_slider">
                            <div class="col-lg-3 col-md-6">
                                <div class="as_product_box">
                                    <div class="as_product_img">
                                        <img src="images/prod1.jpg" alt="" class="img-responsive">

                                        <ul>
                                            <li><a href="cart.html"><img src="images/wishlist.svg" alt=""></a></li>
                                            <li><a href="cart.html"><img src="images/cart.svg" alt=""><span>Add To Card</span></a></li>
                                            <li><a href="shop.html"><img src="images/compare.svg" alt=""></a></li>
                                        </ul>
                                    </div> 
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="as_product_box">
                                    <div class="as_product_img">
                                        <img src="images/prod2.jpg" alt="" class="img-responsive">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="as_product_box">
                                    <div class="as_product_img">
                                        <img src="images/prod3.jpg" alt="" class="img-responsive">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="as_product_box">
                                    <div class="as_product_img">
                                        <img src="images/prod4.jpg" alt="" class="img-responsive">
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <div class="as_overview_slider">
                            <div class="as_overview_inner">
                                ...
                                <span class="as_btn"><img src="images/calender.svg" alt=""> July 29, 2020</span> 
                            </div>
                            <div class="as_overview_inner">
                                <h4 class="as_orange">Mercury in Aries square Mars in Capricorn </h4>
                                <p class="as_font14">Simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum It has survived not only five rinter took a galley of type and scrambled it centuries, but also the passages,</p>
        ...
        <section class="as_footer_wrapper as_padderTop80">
            <div class="container">
                    ...
                    <div class="as_footer_inner as_padderTop50 as_padderBottom80">
                        <div class="row">
                            ...
                            <div class="as_footer_widget">
                                ...
                                <div class="as_share_box">
                                    <p>Follow Us</p>
                                    <ul>
                                        <li><a href="javascript:;"><img src="images/facebook.svg" alt=""></a></li>
                                        <li><a href="javascript:;"><img src="images/twitter.svg" alt=""></a></li>
                                        <li><a href="javascript:;"><img src="images/google.svg" alt=""></a></li>
                                        <li><a href="javascript:;"><img src="images/youtube.svg" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="as_footer_widget">
                               ...
                               <ul>
                                   ...
                                   <li><a href="service_detail.html">
                                    <span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12"> <path d="M8.000,5.998 L-0.002,11.997 L1.292,5.998 L-0.002,-0.001 L8.000,5.998 ZM1.265,9.924 L6.502,5.998 L1.265,2.071 L2.112,5.998 L1.265,9.924 ZM5.451,5.998 L2.496,8.213 L2.974,5.998 L2.496,3.783 L5.451,5.998 Z" class="cls-1"></path> </svg></span> Gemstones</a></li>
                                   <li><a href="service_detail.html"><span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12"> <path d="M8.000,5.998 L-0.002,11.997 L1.292,5.998 L-0.002,-0.001 L8.000,5.998 ZM1.265,9.924 L6.502,5.998 L1.265,2.071 L2.112,5.998 L1.265,9.924 ZM5.451,5.998 L2.496,8.213 L2.974,5.998 L2.496,3.783 L5.451,5.998 Z" class="cls-1"></path> </svg></span> Numerology</a></li>
                                   <li><a href="service_detail.html"><span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12"> <path d="M8.000,5.998 L-0.002,11.997 L1.292,5.998 L-0.002,-0.001 L8.000,5.998 ZM1.265,9.924 L6.502,5.998 L1.265,2.071 L2.112,5.998 L1.265,9.924 ZM5.451,5.998 L2.496,8.213 L2.974,5.998 L2.496,3.783 L5.451,5.998 Z" class="cls-1"></path> </svg></span> Tarot Cards</a></li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="as_footer_widget">
                               ...
                               <ul>
                                   ...
                                   <li><a href="astrologer.html"><span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="8" height="12" viewBox="0 0 8 12"> <path d="M8.000,5.998 L-0.002,11.997 L1.292,5.998 L-0.002,-0.001 L8.000,5.998 ZM1.265,9.924 L6.502,5.998 L1.265,2.071 L2.112,5.998 L1.265,9.924 ZM5.451,5.998 L2.496,8.213 L2.974,5.998 L2.496,3.783 L5.451,5.998 Z" class="cls-1"></path> </svg></span> Astrologers</a></li>
                               ...
                               <ul class="as_contact_list">
                                   <li>
                                       <img src="images/map.svg" alt="">
                                        <p> Astro Susila 
                                            Vedic, ALP, Jamakkol Aarudam, Prasannam.</br>
                                            D 204 Exotica Fresco </br>
                                            Sector 137
                                            Noida 201304</br>
                                        Uttar Pradesh
                                    Online service </p>
                                   ...
                                   <li>
                                       <img src="images/address.svg" alt="">
                                        <p>
                                          <a href="mailto:astrosusila2025@gmail.com ">astrosusila2025@gmail.com </a>
                                        </p> 
                                    </li> 
                                   <li>
                                       <img src="images/call.svg" alt="">
                                        <p>
                                            <a href="javascript:;">+ (91) 7982701690</a>
                                        </p>
                                    </li>
                               </ul>
                            </div>
                        ...
                        <!-- Astro Susila 
Vedic, ALP, Jamakkol Aarudam, Prasannam.
D 204 Exotica Fresco 
Sector 137
Noida 201304
Uttar Pradesh 
Online service 
...
astrosusila2025@gmail.com 
Astrologer 

Appointment 10.00 am to 5.00 pm -->
    ...
    <!-- javascript -->
    <script data-cfasync="false" src="js/email-decode.min.js"></script><script src="js/jquery.min.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/bootstrap.min.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/slick.min.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/jquery.countTo.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/datepicker.min.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/datepicker.en.js" type="970539928961259c7ec9dc02-text/javascript"></script>
    <script src="js/custom.js" type="970539928961259c7ec9dc02-text/javascript"></script>  
<script src="js/rocket-loader.min.js" data-cf-settings="970539928961259c7ec9dc02-|49" defer=""></script><script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'99c4615ea853da9e',t:'MTc2Mjc2NTQ0NA=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script>
</body></html>