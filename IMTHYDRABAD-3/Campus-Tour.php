    ...
    <!-- Top Banner -->
     <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/campustour.jpg); */
    position: relative;
    background-size: cover;
    height: 60vh;">
        <h2 class="display-5 fw-bold mb-2">Campus Tour</h2>
    ...
    <nav aria-label="breadcrumb">
       ...
       <section class="innar">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 innar-top">
                    <!-- You can add breadcrumb or other content here if needed -->
                </div>
      ...
      <h2 class="section-title text-center  mb-4" data-aos="fade-up" data-aos-delay="200">STUDENT LIFE @ IMT HYDERABAD</h2>
        ...
        <div class="gallery">
            ...
            <figure class="gallery__item gallery__item--1">
                <img src="images/g2.png" alt="Campus Image 1" class="gallery__img">
            </figure>
          
            <figure class="gallery__item gallery__item--2">
                <img src="images/g2.png" alt="Campus Image 2" class="gallery__img">
            </figure>
            <figure class="gallery__item gallery__item--3">
                <img src="images/g2.png" alt="Campus Image 3" class="gallery__img">
            </figure>
            <figure class="gallery__item gallery__item--4">
                <img src="images/g2.png" alt="Campus Image 4" class="gallery__img">
            </figure>
           
            <figure class="gallery__item gallery__item--5">
                <img src="images/g2.png" alt="Campus Image 5" class="gallery__img">
            </figure>
            
            <figure class="gallery__item gallery__item--6">
                <img src="images/g2.png" alt="Campus Image 6" class="gallery__img">
            </figure>
            
            <figure class="gallery__item gallery__item--7">
                <img src="images/g2.png" alt="Campus Image 7" class="gallery__img">
            </figure>
            <figure class="gallery__item gallery__item--8">
                <img src="images/g2.png" alt="Campus Image 8" class="gallery__img">
            </figure>
            <figure class="gallery__item gallery__item--9">
                <img src="images/g2.png" alt="Campus Image 9" class="gallery__img">
            </figure>
