...
<body> 
  ...
  <section id="rankings" class="py-5 bg-light">
   <div class="section-header">
            <h2 class="section-title text-center  mb-4" data-aos="fade-up" data-aos-delay="200">Top Business Schools Rankings</h2>
        </div>
      <div class="rankings-card">
        <!-- NIRF Ranking -->
        <div class="mb-4">
          <div class="ranking-header">National Institutional Ranking Framework (NIRF) India Rankings 2025</div>
        ...
        <div class="mb-4">
          <div class="ranking-header">The Week-Hansa Best B-School Rankings 2024</div>
          <ul class="list-group ranking-list">
        ...
        <div class="mb-4">
          <div class="ranking-header">Fortune India-ACRA B-School Rankings 2024</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item bg-transparent border-0">
        ...
        <div class="mb-4">
          <div class="ranking-header">Education World (EW) Higher Education Rankings 2024-25</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item d-flex justify-content bg-transparent border-0">
        ...
        <div class="mb-4">
          <div class="ranking-header">Businessworld B-School Rankings 2024</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item bg-transparent border-0">
        ...
        <div class="mb-4">
          <div class="ranking-header">Business Today - MDRA B-School Ranking 2024</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item bg-transparent border-0">
        ...
        <!-- Careers 360 Ranking -->
        <div class="mb-4">
          <div class="ranking-header">Careers 360 Rankings of India’s Best B-Schools 2025</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item bg-transparent border-0">
        ...
        <!-- GHRDC Ranking -->
        <div class="mb-0">
          <div class="ranking-header">GHRDC B-School Ranking 2025</div>
          <ul class="list-group ranking-list">
            <li class="list-group-item d-flex justify-content bg-transparent border-0">
    ...
    <div class="container">
      ...
      <div class="row logos_section_inner justify-content-center g-4">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="ranking-logo-card text-center">
            <div class="logo-container">
              <img src="images/rank-logo-1.png" alt="NIRF Ranking">
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="ranking-logo-card text-center">
            <div class="logo-container">
              <img src="images/rank-logo-2.png" alt="Education World">
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="ranking-logo-card text-center">
            <div class="logo-container">
              <img src="images/rank-logo-3.png" alt="Business World">
            </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="ranking-logo-card text-center">
            <div class="logo-container">
              <img src="images/rank-logo-4.png" alt="Careers 360">
            </div>
