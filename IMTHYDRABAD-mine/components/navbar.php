...
.navbar {
  position: fixed;
  top: 40px;        /* sits below strip initially */
  left: 0;
  width: 100%;
  z-index: 9999;
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav align-items-lg-center">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-lg border-0 rounded-4" aria-labelledby="moreDropdown" >
            <li><a class="dropdown-item" href="#">PGDM</a></li>
            <li><a class="dropdown-item" href="#">Fellow Program in Management</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-lg border-0 rounded-4" aria-labelledby="moreDropdown" >
            <li><a class="dropdown-item" href="../faculties.php">Faculty Directory</a></li>
            <li><a class="dropdown-item" href="#">Research Publications</a></li>
            <li><a class="dropdown-item" href="#">Research Archives</a></li>
            <li><a class="dropdown-item" href="#">Centre for Sustainability and CSR</a></li>
            <li><a class="dropdown-item" href="#">Centre for Digital Transformation</a></li>
            <li><a class="dropdown-item" href="#">Innovation Lab</a></li>
            <li><a class="dropdown-item" href="#">Awards &amp; Recognitions</a></li>
          </ul>
        </li>
        <!-- Dropdown Menu -->
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu shadow-lg border-0 rounded-4" aria-labelledby="moreDropdown">
            ...
            <li><a class="dropdown-item" href="#">Events & Conferences</a></li>
            <li><a class="dropdown-item" href="#">Alumni</a></li>
            <li><a class="dropdown-item" href="#">International Relations</a></li>
            <li><a class="dropdown-item" href="#">Placements</a></li>
            <li><a class="dropdown-item" href="#">Ranking & Accreditation</a></li>
            <li><a class="dropdown-item" href="#">About IMT Hyderabad</a></li>
            <li><a class="dropdown-item" href="#">Contact & Directions</a></li>
          </ul>
        </li>
      </ul>
