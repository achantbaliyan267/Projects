  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg">
      ...
      <div class="modal-body text-center">
        <img src="./media/qr.jpg" alt="QR Code" style="height:300px" class="img-fluid rounded">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-6 footer-links">
      ...
      <ul>
        ...
        <li><a href="#">Research & Advisory</a></li>
    ...
    <div class="d-flex flex-wrap align-items-center gap-3 mt-2">
      <img src="https://www.imthyderabad.edu.in/assets/images/about/nba.png" alt="Accreditation 1" style="height:40px;">
      <img src="https://www.imthyderabad.edu.in/assets/images/about/sas.jpg" alt="Accreditation 2" style="height:40px;">
      <img src="https://www.imthyderabad.edu.in/assets/images/about/aiu.png" alt="Accreditation 3" style="height:40px;">
      <img src="https://www.imthyderabad.edu.in/assets/images/aicte-logo.png" alt="Accreditation 4" style="height:40px;">
      <img src="./media/aacsb-logo.jpg" alt="Accreditation 4" style="height:40px;">
    </div>
  </div>
      </div>
    </div>
