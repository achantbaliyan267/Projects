  <!DOCTYPE html>
    ...
    <!-- Top Banner -->
     <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/ranking.webp); position: relative; background-size: cover; height: 60vh;">
        <h2 class="display-5 fw-bold mb-2">Student Life</h2>
        <p class="text-white">A place where learning meets enriched living.
<br>
Our vibrant campus culture inspires creativity, leadership, and lifelong friendships through academics, activities, and collaboration.</p>
    </div>
...
<section id="international-associations" class="py-5">
  <div class="container" data-aos="fade-up" data-aos-delay="200">
    ...
    <div class="text-center mb-5">
      <h2 class="section-title" style="color:#08317a;">Student Life</h2>
    </div>
    <!-- Updated Content -->
    <div class="row justify-content-center">
      <div class="col-12 col-md-10" data-aos="fade-up" data-aos-delay="250">
        <p class="mb-4 fst-italic text-dark">
...
<!-- Student Life Image Gallery -->
<section id="student-life-gallery" class="py-5 " style="background-color: #163977">
  <div class="container" data-aos="fade-up" data-aos-delay="200">
    <!-- Section Header -->
    <div class="text-center mb-5">
      <h2 class="section-title text-warning">Life at IMT Hyderabad</h2>
      <p class="text-light">Moments from campus life, events, and activities</p>
    </div>
    ...
    <div class="row g-4">
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/1.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 1">
      ...
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="150">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/2.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 2">
      ...
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/4.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 3">
      ...
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/3.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 4">
          
        </div>
      </div>
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/7.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 4">
          
        </div>
      </div>
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/5.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 4">
          
        </div>
      </div>
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/8.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 4">
          
        </div>
      </div>
      <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
        <div class="card border-0 shadow-sm overflow-hidden">
          <img src="./media/std-life/6.JPG" class="card-img-top img-fluid h-100" style="height:200px !important" alt="Event 4">
