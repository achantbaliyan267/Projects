 <!DOCTYPE html>
    ...
    height: 60vh;">
        ...
        <p class="text-white">Governed by transparency, guided by integrity.
<br>
...
<section id="committees" class="py-5">
  <div class="container">
    ...
    <!-- Tabs Navigation -->
    <ul class="nav nav-pills justify-content-center mb-4 gap-2" id="CommitteesTabs" role="tablist" data-aos="zoom-in" data-aos-delay="200">
