  ...
  <div class="container shadow-sm">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav align-items-lg-center">
        <li class="nav-item"><a class="nav-link" href="placements">HOME</a></li>
        <li class="nav-item"><a class="nav-link" href="campus-recruitment">CAMPUS PLACEMENTS</a></li>
        <li class="nav-item"><a class="nav-link" href="internship">SUMMER INTERNSHIPS</a></li>
        <li class="nav-item"><a class="nav-link" href="corporate-connect">CORPORATE CONNECT</a></li>
      ...
      <!-- Contact Us Button -->
      <a href="../contact-us" class="btn btn-warning border-dark rounded-pill mx-3">
        CONTACT US
      </a>
    </div>
  </div>
