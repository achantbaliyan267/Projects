...
<section class="faculty-section">
  ...
  <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/carrier.webp); */
    ...
    height: 60vh;">
    <h2 class="display-5 fw-bold mb-2">Careers</h2>
    <p class="text-white">A workplace that values intellect, innovation, and purpose. <br> Join an institution that empowers talent to shape the future of management education. </p>
  </div>
...
<!-- End Google Tag Manager (noscript) --> 
       <div class="container mt-4">
        <h2 class="section-title text-center  mb-4" data-aos="fade-up" data-aos-delay="200">Careers</h2>
        <div class="row justify-content-center">
            <div class="col-12">
                
                        
                        <ul class="nav nav-pills" id="careersTab" role="tablist" >
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="guidelines-tab" data-bs-toggle="pill" data-bs-target="#guidelines" type="button" role="tab" aria-controls="guidelines" aria-selected="true">
                                    Faculty Positions - Guidelines
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="apply-faculty-tab" data-bs-toggle="pill" data-bs-target="#apply-faculty" type="button" role="tab" aria-controls="apply-faculty" aria-selected="false">
                                    Faculty Positions - Apply Now
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="apply-non-teaching-tab" data-bs-toggle="pill" data-bs-target="#apply-non-teaching" type="button" role="tab" aria-controls="apply-non-teaching" aria-selected="false">
                           ...
                           <div class="tab-pane fade show active" id="guidelines" role="tabpanel" aria-labelledby="guidelines-tab"> <div class="row justify-content-center"> <div class="col-lg-10"> <p class="mb-4">Self-motivated and suitably qualified persons are invited to join the vibrant team of faculty members in the following areas:</p> <ul class="mb-4"> <li>Analytics & IT</li> <li>Decision Science</li> <li>Finance & Accounting</li> <li>General Management</li> <li>Human Resources Management</li> <li>Marketing Management</li> <li>Operations Management</li> </ul> <p class="mb-4">All of the above positions require proficiency in teaching, research and industry practice. Specific requirements are as follows:</p>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    ...
                                    <p class="mb-4"><b>Eligibility & Experience:</b> Outstanding academic record throughout. Should have a Post Graduate degree in Management/Allied areas and PhD/FPM from a reputed institution or university. Candidates should be familiar with industry practices and challenges and show evidence of quality research and publications. Minimum three years of teaching/research/industrial experience (excluding the experience gained while pursuing PhD). Candidates who have submitted their PhD Thesis may also apply. They will be offered a temporary position and will be placed as Assistant Professor after the award of doctoral degree.</p>

                                    <p class="mb-4"><b>Compensation:</b> Compensation is equivalent to UGC norms and as per the rules of the Institute as revised from time to time depending upon their length of experience. The fringe benefits, such as HRA, medical insurance, contribution towards provident fund / New Pension Scheme (NPS), Faculty Development Allowance, financial support towards national and international conferences etc. shall be given as per the Institute norms. Monetary incentives are given for research paper and case publications in reputed journals. Faculty members are permitted to pursue industrial consultancy on income sharing basis as per Institute rules.</p>

                                    <p class="mb-4">A faculty is expected to teach 140 hrs in a year. They are also required to publish in reputed journals (ABDC) to earn a minimum number of research points, conduct MDPs, and provide consultancy and institutional services.</p>

                                    <p class="mb-4"><b>Indicative Guidelines for Shortlisted Candidates:</b> <a href="https://drive.google.com/file/d/103o59AmRCPlTjsayjYFgJwpZtdq-ItwQ/view?usp=sharing" target="_blank">Click Here</a></p>

                                    <p class="mb-4"><b>Interested candidates may submit their applications in the prescribed form</b> <a href="https://docs.google.com/document/d/1Iu3RvurN74TRqvdCaQ6mqJAJSeH8tptm/edit?usp=sharing&ouid=106736229483075051654&rtpof=true&sd=true" target="_blank">(Download the form here)</a> and send the filled up application form along with a cover letter (if any) to <u>careers@imthyderabad.edu.in</u></p>
                                </div>
                            </div>
                        </div>

                            <!-- Non-Teaching Positions Tab -->
                             <!-- Non-Teaching Positions - Apply Now Tab -->
                        <div class="tab-pane fade" id="apply-non-teaching" role="tabpanel" aria-labelledby="apply-non-teaching-tab">
                            <div class="row justify-content-center">
                                <div class="col-lg-10">
                                    <p class="mb-4">Institute of Management Technology Hyderabad invites applications for the position of</p>

                                    <div class="mb-4">
                                        <h5>Admissions Manager at IMT Hyderabad</h5>
                                        <p class="mb-3"><b>Job Description</b></p>
                                        <p class="mb-3">Institute of Management Technology (IMT) Hyderabad is a premier business school known for its academic excellence, industry-aligned curriculum, and strong corporate connections. As part of the prestigious IMT group, IMT Hyderabad offers cutting-edge management education and fosters leadership and innovation among its students.</p>

                                        <p class="mb-3"><b>Position Overview</b></p>
                                        <p class="mb-3">We are seeking an experienced and dynamic <b>Admissions Manager</b> to oversee the admissions process and drive student recruitment for IMT Hyderabad. The ideal candidate will have a strong network within schools and colleges, reputed coaching institutions along with in-depth knowledge of the management education sector (covering AICTE approved PG Diploma in Management programme). This role involves managing the entire admissions lifecycle—from student outreach and application evaluation to enrolment and stakeholder engagement—while ensuring alignment with the institute's vision and policies. The Admissions Manager will also lead outreach initiatives, ensure compliance with institutional policies, and work closely with various stakeholders to achieve enrolment targets.</p>

                                        <p class="mb-3"><b>Key Responsibilities</b></p>
                                        <p class="mb-3"><b>Admissions Process Management</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Student Recruitment & Outreach</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Communication & Stakeholder Engagement</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Performance & Compliance</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Team Leadership & Collaboration</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Requirements & Qualifications</b></p>
                                        <p class="mb-3"><b>Education & Experience</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Skills & Competencies</b></p>
                                        <div class="crs_list">
                                            <ul>
                                        ...
                                        <p class="mb-3"><b>Salary, allowances and benefits:</b></p>
                                        <p class="mb-3">As per IMT Norms corresponding with the qualifications, experience and performance in the interview. Salary will not be a constraint for the deserving candidate.</p>
                                    </div>

                                    <div class="mb-4">
                                        <h5>Counsellor/ Clinical Psychologist at IMT Hyderabad</h5>
                                        <p class="mb-3"><b>Function:</b></p>
                                        <p class="mb-3">IMT Hyderabad invites applications for the position of <b>Counsellor/Clinical Psychologist</b> to support the mental, emotional, and physical well-being of students in our residential academic community. The selected candidate will play a pivotal role in fostering a supportive environment, ensuring students thrive academically and personally.</p>

                                        <p class="mb-3"><b>Job Description / Key Responsibilities:</b></p>
                                        <div class="crs_list">
                                            <ul>
                                                <li>Provide confidential, high-quality counselling to students addressing academic stress, emotional challenges, and social                                            <li>Provide confidential, high-quality counselling to students addressing academic stress, emotional challenges, and social adjustments.</li>
                                            ...
                                            <p class="mb-3"><b>Qualifications & Skills:</b></p>
                                            <div class="crs_list">
                                                <ul>
                                            ...
                                            <p class="mb-3">This role is ideal for a proactive and highly organized professional who thrives in a dynamic academic environment.</p>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="mb-3"><b>Function:</b></p>
                                            <p class="mb-3">The role involves -</p>
                                            <div class="crs_list">
                                                <ul>
                                            ...
                                            <p class="mb-3"><b>Qualification:</b></p>
                                            <p class="mb-3">The incumbent should have relevant experience with bachelor's degree or higher in any discipline and expertise in advanced Microsoft Excel and database management.</p>

                                            <p class="mb-3"><b>Desirable Skills and Abilities:</b></p>
                                            <div class="crs_list">
                                                <ul>
                                            ...
                                            <p class="mb-3"><b>Salary & Allowances:</b></p>
                                            <p class="mb-3">The selected candidate will be offered initially on a fixed-term contract for a period of two years on a consolidated monthly pay package subject to satisfactory performance, which will be reviewed on an annual basis. <b>Salary will not be a constraint for the deserving candidate.</b> The selected candidate would be evaluated after three months of joining and would be able to complete first year in the Institute only if the performance is found satisfactory at the end of three months.</p>
                                        </div>

                                        <div class="mb-4">
                                            <h5>Academic Associates (2)</h5>
                                            <p class="mb-3"><b>Function:</b></p>
                                            <p class="mb-3">The role involves working closely with the Teaching Staff for various academic and administrative works. Academic Associates (AAs) shall perform any other related activities of the Institute and assist the faculty in their research work also.</p>

                                            <p class="mb-3"><b>Qualification:</b></p>
                                            <p class="mb-3">The incumbent should have a first-class postgraduate degree in Management or Social Science / Law and relevant research experience. Fresh PhD from reputed institutions are encouraged to apply.</p>

                                            <p class="mb-3"><b>Key Skills:</b></p>
                                            <div class="crs_list">
                                                <ul>
                                            ...
                                            <p class="mb-3"><b>Age:</b> Below 32 years (Preferably be below 30 years of age). However, for PhD candidates/Candidates with relevant experience, the Age limit can be extended up to 35 Years.</p>

                                            <p class="mb-3"><b>Stipend & Benefits:</b> In the range of Rs 35,000 - Rs 50,000 per month depending on the qualifications, experience and performance in the interview.</p>
                                        </div>
