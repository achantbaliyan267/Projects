...
<body>
    <?php include "./components/navbar.php"?>
        ...
        <section class="faculty-section">
            <!-- Top Banner -->
            <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/csr.webp); 
    position: relative;
    background-size: cover;
    height: 60vh;">
                <h2 class="display-5 fw-bold mb-2">Centre For Sustainability & CSR</h2>
                <p class="text-white">Committed to business with a conscience.
<br>
Our Centre for Sustainability and CSR integrates responsible management and social innovation into education and research.</p>
            </div>
                ...
                <div class="tab-pane fade show active bg-white p-4 rounded-4 text-black" id="tab-sus" role="tabpanel">
                    ...
                    <div class="tab-content container-sm text-black mb-4">
                        ...
                        <div class="tab-pane fade show active" id="sub-res-susabt" role="tabpanel">
                            ...
                            <br>
                            <br>
                            <div class="centre_award">
                                <div class="camp_imgg">
                                    <img src="./media/center-csr/csr.png" alt="csr" width="100%" class="img-responsive">
                                    <br>
                                    <br>
                            ...
                            <h4  style="color:#08317a;"><b>Objective of the Centre for Sustainability and CSR</b></h4>
                            <div class="crs_list">
                                <ul>
                            ...
                            <h4  style="color:#08317a;"><b>Activities of the Centre for Sustainability and CSR</b></h4>
                            <div class="crs_list">
                                <ul>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/1.webp" class="img-fluid rounded-start mt-2" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Shri Ashok K. Pavadia</p>
                                                        <br>
                                                        ...
                                                        <button class="bg-warning text-white px-3 py-2 border-0 rounded-4"><a href="https://www.imthyderabad.edu.in/assets/images/admissions/AKP_profile.pdf">View Profile</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/2.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Shri. S.K . Joshi</p>
                                                        <br>
                                                        <p class="card-text">IAS (retired), Former Chief Secretary</p>
                                                        <p class="card-text">Govt of Telangana</p>
                                                        <button class="bg-warning text-white px-3 py-2 border-0 rounded-4"><a href="https://www.imthyderabad.edu.in/assets/images/faculty/pdf/skj.pdf">View Profile</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/3.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Shri. S. Shoury Reddy</p>
                                                        <br>
                                                        <p class="card-text">Executive Director</p>
                                                        <p class="card-text">BalaVikasa</p>
                                                        <button class="bg-warning text-white px-3 py-2 border-0 rounded-4"><a href="https://www.imthyderabad.edu.in/assets/images/admissions/srprofile.pdf">View Profile</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/4.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Shri Ashok K. Pavadia</p>
                                ...
                                <div class="row mb-4 mt-5">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/5.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Dr. Sourabh Bhattacharya</p>
                                                        <br>
                                                        <p class="card-text">Chairperson, Centre for Sustainability and CSR</p>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/6.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Dr. Tulika Sharma</p>
                                                        <br>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/7.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/8.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Prof. Pushpesh Pant</p>
                                                        <br>
                                                        <p class="card-text">Assistant Professor</p>
                                                        <p class="card-text">Operational Management</p>
                                                        <button class="bg-warning text-white px-3 py-2 border-0 rounded-4"><a href="">View Profile</a></button>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100 p-4">
                                            <div class="row g-0">
                                                <div class="col-md-5">
                                                    <img src="./media/center-csr/9.webp" class="img-fluid rounded-start" alt="Student Photo" style="height:14rem;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="card-body">
                                                        <p class="card-title fw-bold fs-4">Mr. Vijay Kumar Machcha</p>
                                                        <br>
                                                        <p class="card-text">Sustainability and CSR Professional</p>
                                                        <p class="card-text">Startup Mentor and Guide</p>
                                                        <button class="bg-warning text-white px-3 py-2 border-0 rounded-4"><a href="">View Profile</a></button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="sub-res-susne" role="tabpanel">
                            <p>IMT Hyderabad held an inauguration ceremony to launch the Centre for Sustainability and CSR on 7th August 2021. The session began with an inaugural address by Prof. (Dr.) Tulika Sharma, Chairperson - Centre for Sustainability
                                ...
                                <br>
                                <br> The event also witnessed a brief address by Prof. (Dr.) Sriharsha Reddy, Director Designate, IMT Hyderabad, shared his vision of the centre contributing to nurturing socially responsible leaders. The event concluded with
