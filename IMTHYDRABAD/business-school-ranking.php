...
<section class="faculty-section">
  <!-- Top Banner -->
  <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/ranking.webp); 
    position: relative;
    background-size: cover;
    height: 60vh;">
    <h2 class="display-5 fw-bold mb-2">Top Business Schools Rankings</h2>
    <p class="text-white">Recognized nationally for excellence and innovation.
<br>
Our consistent rankings reflect academic quality, strong outcomes, and our growing reputation in management education.</p>
  </div>
