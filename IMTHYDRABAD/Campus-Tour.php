    ...
    <!-- Top Banner -->
     <div class="faculty-hero text-center text-white py-5" style="background: url(./media/banners/campustour.webp); */
    position: relative;
    background-size: cover;
    height: 60vh;">
        <h2 class="display-5 fw-bold mb-2">Campus Tour</h2>
        <p class="text-white">A campus built for ideas, collaboration, and growth.
<br>
Discover state-of-the-art learning spaces designed to inspire innovation and community.</p>
    </div>
