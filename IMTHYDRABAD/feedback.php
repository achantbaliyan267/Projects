...
<!-- End Google Tag Manager (noscript) -->
    ...
    height: 60vh;">
        <h2 class="display-5 fw-bold mb-2">Feedback Facility for Students and Faculty</h2>
        <p class="text-white">Listening to grow stronger together.
<br>
We value constructive feedback from students, faculty, and stakeholders to enhance quality and enrich experiences.</p>
    </div>
    ...
    <nav aria-label="breadcrumb">
     ...
     Feedback Facility for Students and Faculty</li>
        </ol>
    </nav>
    </div>
    </div>
   ...
   <div class="card p-4">
     ...
     <div class="row justify-content-center mt-3 ">
      <div class="col-lg-12 text-justify">
              <p>Feedback Facility for Students and Faculty in AICTE Web Portal: <a href="#" target="_blank">Click Here</a></p>
